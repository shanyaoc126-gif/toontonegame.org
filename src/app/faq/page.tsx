    ...
    items: [
      {
        ...
        a: <>You can play — nothing in the game blocks you — but know what it is and isn&apos;t. ToonTone is a matching game, not a color vision test: it can&apos;t diagnose, screen, or certify anything about your eyes. Players with color vision deficiency will find some hue regions harder to discriminate than others, and scores will reflect that. If you have concerns about your color vision, a clinician with proper test plates is the address — not a browser game.</>,
        aText: 'You can play — nothing in the game blocks you — but know what it is and isn\'t. ToonTone is a matching game, not a color vision test: it can\'t diagnose, screen, or certify anything about your eyes. Players with color vision deficiency will find some hue regions harder to discriminate than others, and scores will reflect that. If you have concerns about your color vision, a clinician with proper test plates is the address — not a browser game.',
      },
      {
